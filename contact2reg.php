               ...
               <div class="row">
                  ...
                  if(empty($Mensaje))
						...
						if( (!empty($Nombre)) && (!empty($Email)) && (!empty($Mensaje)) )
						{
							...
							$Servidor="lfmerukkeiac5y5w.cbetxkdyhwsb.us-east-1.rds.amazonaws.com";
							$UsarioDB="sutj46vk6mx7olh0";
							$ClaveDB="pg6dxl4q5g9tbx3p";
							$DB="d86efb2umavb64qn";
							...
							if(mysqli_query($Conectarme,$Guardar))
							{
								...
								echo"<h3><h2><a href='contact2.php'>Contactar de nuevo.</a></h2>";
							}else{
